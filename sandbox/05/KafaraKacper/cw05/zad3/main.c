...
int main(int argc, char * argv[])
{
    ...
    const char * const producers[] = {
        "./producent ./fifo 0 ./testdata/input_main1.txt 4",
        "./producent ./fifo 3 ./testdata/input_main2.txt 4",
        "./producent ./fifo 4 ./testdata/input_main3.txt 4",
        "./producent ./fifo 5 ./testdata/input_main4.txt 4",
        "./producent ./fifo 9 ./testdata/input_main5.txt 4",
    };
